  ...
  <div class="mv-detail">
    <div class="content">
      <div class="detail">
        ...
        <div class="video">
          <video :src="mvUrl" controls autoplay="autoplay" width="375px"></video>
        </div>
        <div class="mv-artist">
        ...
        <div class="comment">
          ...
          <comment-card v-for="(item,index) in commentInfo" :key="index" :likedCount="item.likedCount" :name="item.user.nickname" :pic="item.user.avatarUrl" :text="item.content" :time="item.time" :uid="item.commentId" @handleReplyComment="handleReplyComment">
...
import { getMvUrl, getMvComment, getRecommentMv } from "../../network/api";
export default {
